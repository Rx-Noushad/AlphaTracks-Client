    ...
    return (
        <div className="text-light bg-dark py-5">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-3 mt-3">
                        ...
                        <div className="quick-links text-center">
                            ...
                            <Link style={{ textDecoration: 'none', color: 'white' }} to="/blogs" className="navItems">Blogs</Link>
                            {
                ...
                <p className="mt-3 text-center mt-5">@ 2023 AlphaTracks All Rights Reserved</p>
            </div>
        </div>
    );
};
