...
const CheckoutForm = ({ order }) => {
    ...
    useEffect(() => {
        ...
        fetch('https://alpha-tracks-server-site-kw9aq2sdn-rx-noushad.vercel.app/create-payment-intent', {
            method: "POST",
            headers: {
    ...
    const handleSubmit = async (event) => {
        ...
        if (clientSecret.intent === "succeeded") {
            ...
            fetch('https://alpha-tracks-server-site-kw9aq2sdn-rx-noushad.vercel.app/payments', {
                method: 'POST',
                headers: {
                    'content-type': 'application/json'
                },
