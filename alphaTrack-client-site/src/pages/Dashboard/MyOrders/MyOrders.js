...
const MyOrders = () => {
    ...
    useEffect(() => {
        fetch(`https://alpha-tracks-server-site-kw9aq2sdn-rx-noushad.vercel.app/orders/${user.email}`)
            .then(res => res.json())
            .then(data => {
                setOrders(data);
            })
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    fetch(`https://alpha-tracks-server-site-kw9aq2sdn-rx-noushad.vercel.app/orders/${id}`, {
                        method: 'DELETE',
                        headers: {
